...
<div id="carouselExampleDark" class="carousel carousel-dark slide">
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="jogos/Pubg/images/pubg_banner.jpg" class="carrosel-img" alt="...">
        </div>
    </div>
  ...
  <div class="card m-3 centro font" style="width: 18rem;" id="gridEquipe">
    <img src="jogos/Pubg/images/1.jpg" class="card-img-top" alt="...">
    <div class="card-body">
    </div>
  </div>

  <div class="card m-3 centro font" style="width: 18rem;" id="gridEquipe">
    <img src="jogos/Pubg/images/2.jpg" class="card-img-top" alt="...">
    <div class="card-body">
    </div>
  </div>

  <div class="card m-3 centro font" style="width: 18rem;" id="gridEquipe">
    <img src="jogos/Pubg/images/3.jpg" class="card-img-top" alt="...">
    <div class="card-body">
    </div>
  </div>
